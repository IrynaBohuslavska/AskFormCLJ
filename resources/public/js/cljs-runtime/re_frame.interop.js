...
return [(function (){var pred__60509 = cljs.core.instance_QMARK_;
var expr__60510 = reactive_val;
if(cljs.core.truth_((pred__60509.cljs$core$IFn$_invoke$arity$2 ? pred__60509.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__60510) : pred__60509.call(null,reagent.ratom.RAtom,expr__60510)))){
return "ra";
} else {
if(cljs.core.truth_((pred__60509.cljs$core$IFn$_invoke$arity$2 ? pred__60509.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__60510) : pred__60509.call(null,reagent.ratom.RCursor,expr__60510)))){
return "rc";
} else {
if(cljs.core.truth_((pred__60509.cljs$core$IFn$_invoke$arity$2 ? pred__60509.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__60510) : pred__60509.call(null,reagent.ratom.Reaction,expr__60510)))){
return "rx";
} else {
if(cljs.core.truth_((pred__60509.cljs$core$IFn$_invoke$arity$2 ? pred__60509.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__60510) : pred__60509.call(null,reagent.ratom.Track,expr__60510)))){
return "tr";
} else {
return "other";
}
