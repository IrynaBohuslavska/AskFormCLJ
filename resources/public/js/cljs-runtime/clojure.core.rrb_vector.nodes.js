...
var G__63627 = (root.arr[(slc - (1))]);
var G__63628 = (shift - (5));
var G__63629 = (((rngs[(31)]) - (rngs[(30)])) + (32));
root = G__63627;
shift = G__63628;
cnt = G__63629;
continue;
...
if((!(r_QMARK_))){
var rngs_63638 = clojure.core.rrb_vector.nodes.node_ranges(parent);
var rng0_63639 = (rngs_63638[(0)]);
var new_rngs_63640 = [null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null];
var lim_63641 = (rngs_63638[(32)]);
cljs.core.array_copy(rngs_63638,(1),new_rngs_63640,(0),(lim_63641 - (1)));

var i_63642 = (0);
while(true){
if((i_63642 < lim_63641)){
(new_rngs_63640[i_63642] = ((new_rngs_63640[i_63642]) - rng0_63639));

var G__63643 = (i_63642 + (1));
i_63642 = G__63643;
continue;
} else {
}
...
(new_rngs_63640[(32)] = ((rngs_63638[(32)]) - (1)));

(new_rngs_63640[((rngs_63638[(32)]) - (1))] = (0));

(new_arr[(32)] = new_rngs_63640);
} else {
}
...
while(true){
if((i_63644 <= li)){
(new_rngs[i_63644] = ((new_rngs[(i_63644 - (1))]) + step));

var G__63645 = (i_63644 + (1));
i_63644 = G__63645;
continue;
} else {
}
...
while(true){
if((i_63646 <= li)){
(new_rngs[i_63646] = ((rngs[i_63646]) - d));

var G__63647 = (i_63646 + (1));
i_63646 = G__63647;
continue;
} else {
}
...
while(true){
if((j_63648 <= i)){
(rngs[j_63648] = r_63649);

var G__63650 = (j_63648 + (1));
var G__63651 = (r_63649 + step);
j_63648 = G__63650;
r_63649 = G__63651;
continue;
} else {
...
var rngs = (((!(reg_QMARK_)))?(function (){var G__63620 = [null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null];
(G__63620[(0)] = node.arr.length);
...
var arr_63652__$1 = arr;
var shift_63653__$1 = shift;
while(true){
if((shift_63653__$1 === (5))){
if((!(reg_QMARK_))){
(arr_63652__$1[(32)] = rngs);
} else {
}

(arr_63652__$1[(0)] = node);
} else {
var a_63654 = (new Array(len));
var e_63655 = cljs.core.__GT_VectorNode(null,a_63654);
(arr_63652__$1[(0)] = e_63655);
...
var G__63656 = a_63654;
var G__63657 = (shift_63653__$1 - (5));
arr_63652__$1 = G__63656;
shift_63653__$1 = G__63657;
continue;
}
break;
}
...
var cret = (((shift === (5)))?cljs.core.__GT_VectorNode(null,tail):(function (){var G__63621 = (arr[(li - (1))]);
var G__63622 = (shift - (5));
var G__63623 = ((clojure.core.rrb_vector.nodes.regular_QMARK_(node))?cljs.core.mod(cnt,((1) << shift)):(function (){var li__$1 = ((rngs[(32)]) - (1));
if((li__$1 > (0))){
...
var G__63624 = tail;
return (clojure.core.rrb_vector.nodes.fold_tail.cljs$core$IFn$_invoke$arity$4 ? clojure.core.rrb_vector.nodes.fold_tail.cljs$core$IFn$_invoke$arity$4(G__63621,G__63622,G__63623,G__63624) : clojure.core.rrb_vector.nodes.fold_tail.call(null,G__63621,G__63622,G__63623,G__63624));
})());
