...
if((x instanceof cljs.core.Keyword)){
var G__62207 = spec;
var G__62208 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__62207,G__62208) : f.call(null,G__62207,G__62208));
} else {
if(typeof x === 'string'){
...
if((x instanceof cljs.core.Keyword)){
var G__62221 = spec;
var G__62222 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__62221,G__62222) : f.call(null,G__62221,G__62222));
} else {
return x;
...
if(typeof x === 'number'){
var G__62225 = spec;
var G__62226 = spec_tools.transform.number__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__62225,G__62226) : f.call(null,G__62225,G__62226));
} else {
if(typeof x === 'string'){
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(spec,x) : f.call(null,spec,x));
} else {
...
}catch (e62227){if((e62227 instanceof Error)){
var ___$1 = e62227;
return x;
} else {
throw e62227;
...
}catch (e62228){if((e62228 instanceof Error)){
var ___$1 = e62228;
return x;
} else {
throw e62228;
...
}catch (e62231){if((e62231 instanceof Error)){
var ___$1 = e62231;
return x;
} else {
throw e62231;
...
}catch (e62232){if((e62232 instanceof Error)){
var ___$1 = e62232;
return x;
} else {
throw e62232;
...
}catch (e62233){if((e62233 instanceof Error)){
var ___$1 = e62233;
return x;
} else {
throw e62233;
...
}catch (e62234){if((e62234 instanceof Error)){
var ___$1 = e62234;
return x;
} else {
throw e62234;
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__62237,x){
var map__62238 = p__62237;
var map__62238__$1 = cljs.core.__destructure_map(map__62238);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62238__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__62241,x){
var map__62242 = p__62241;
var map__62242__$1 = cljs.core.__destructure_map(map__62242);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62242__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__62243,x){
var map__62244 = p__62243;
var map__62244__$1 = cljs.core.__destructure_map(map__62244);
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62244__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));
