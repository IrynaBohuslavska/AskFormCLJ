...
var o61829 = temp__5751__auto__;
var temp__5751__auto____$1 = (o61829["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o61830 = temp__5751__auto____$1;
return (o61830["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__61123__auto__ = f;
return (o__61123__auto__["toString"]).call(o__61123__auto__);
} else {
return "";
}
}catch (e61832){var _ = e61832;
return "";
}});
...
try{var o__61123__auto___62239 = t;
(o__61123__auto___62239["cljs$lang$ctorPrWriter"]).call(o__61123__auto___62239,t,writer);
}catch (e61845){var __62240 = e61845;
}
...
var char_code = (function (){var o__61123__auto__ = (new String(char$));
return (o__61123__auto__["charCodeAt"]).call(o__61123__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__61123__auto__ = String;
return (o__61123__auto__["fromCharCode"]).call(o__61123__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__61856 = num_code;
switch (G__61856) {
case (1):
return (185);
...
var o__61123__auto__ = String;
return (o__61123__auto__["fromCharCode"]).call(o__61123__auto__,superscript_code);
});
/**
...
}catch (e61883){var _e__61146__auto__ = e61883;
return false;
}})())){
...
var vec__61888 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61888,(0),null);
...
var len__4829__auto___62262 = arguments.length;
var i__4830__auto___62263 = (0);
while(true){
if((i__4830__auto___62263 < len__4829__auto___62262)){
args__4835__auto__.push((arguments[i__4830__auto___62263]));

var G__62264 = (i__4830__auto___62263 + (1));
i__4830__auto___62263 = G__62264;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__61962){
var vec__61963 = p__61962;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61963,(0),null);
...
var G__62269 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__62270 = cljs.core.butlast(remaining_tokens);
name_tokens = G__62269;
remaining_tokens = G__62270;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq61948){
var G__61949 = cljs.core.first(seq61948);
var seq61948__$1 = cljs.core.next(seq61948);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__61949,seq61948__$1);
}));
...
var vec__61986 = cljs.core.split_with((function (p1__61981_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__61981_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61986,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61986,(1),null);
...
var vec__62013 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62013,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62013,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__62278 = cljs.core.rest(remaining_tokens);
var G__62279 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__62278;
name_tokens = G__62279;
continue;
} else {
...
var vec__62023 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62023,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62023,(1),null);
var vec__62026 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62026,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62026,(1),null);
var vec__62029 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62029,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62029,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62029,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62029,(3),null);
...
var vec__62040 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62040,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62040,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62040,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62040,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62040,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62040,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__62047 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62047,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62047,(1),null);
var vec__62051 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62051,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62051,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__62062 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__62062) : devtools.munging.parse_fn_info_deep.call(null,G__62062));
})()));
}
} else {
return fn_info;
...
var G__62296 = (arity + (1));
var G__62297 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__62079){
var vec__62080 = p__62079;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62080,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62080,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__62092_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__62092_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__62093_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__62093_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__62101){
var vec__62102 = p__62101;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62102,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq62097){
var G__62098 = cljs.core.first(seq62097);
var seq62097__$1 = cljs.core.next(seq62097);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__62098,seq62097__$1);
}));
...
var map__62167 = options;
var map__62167__$1 = cljs.core.__destructure_map(map__62167);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62167__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62167__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62167__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62167__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__62168 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62168,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62168,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62168,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62168,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62168,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62168,(5),null);
...
var o__61123__auto__ = f;
return (o__61123__auto__["getBasis"]).call(o__61123__auto__);
});
/**
...
}catch (e62171){var _e__61146__auto__ = e62171;
...
var G__62333 = (obj[cljs.core.first(path)]);
var G__62334 = cljs.core.rest(path);
obj = G__62333;
path = G__62334;
continue;
} else {
...
var _STAR_ = (function (accum,p__62200){
var vec__62201 = p__62200;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62201,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62201,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__62213){
var vec__62215 = p__62213;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62215,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62215,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62215,(2),null);
...
var post_process = (function (p__62226){
var vec__62227 = p__62226;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62227,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62227,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__62221_SHARP_){
return (obj[cljs.core.first(p1__62221_SHARP_)]);
}),sorted_matches);
