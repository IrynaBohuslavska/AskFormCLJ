...
fipp.edn.pretty_coll = (function fipp$edn$pretty_coll(p__64087,open,xs,sep,close,f){
var map__64088 = p__64087;
var map__64088__$1 = cljs.core.__destructure_map(map__64088);
var printer = map__64088__$1;
var print_level = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64088__$1,new cljs.core.Keyword(null,"print-level","print-level",-1825423733));
var print_length = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64088__$1,new cljs.core.Keyword(null,"print-length","print-length",1931866356));
var printer__$1 = (function (){var G__64089 = printer;
if(cljs.core.truth_(print_level)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__64089,new cljs.core.Keyword(null,"print-level","print-level",-1825423733),cljs.core.dec);
} else {
return G__64089;
}
})();
var xform = cljs.core.comp.cljs$core$IFn$_invoke$arity$3((cljs.core.truth_(print_length)?cljs.core.take.cljs$core$IFn$_invoke$arity$1(print_length):cljs.core.identity),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__64086_SHARP_){
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(printer__$1,p1__64086_SHARP_) : f.call(null,printer__$1,p1__64086_SHARP_));
...
(fipp.edn.EdnPrinter.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4474__auto__,k64093,else__4475__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k64093,else__4475__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4495__auto__,p__64105){
var vec__64106 = p__64105;
var k__4496__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64106,(0),null);
var v__4497__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64106,(1),null);
...
(fipp.edn.EdnPrinter.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__64092){
var self__ = this;
var G__64092__$1 = this;
return (new cljs.core.RecordIter((0),G__64092__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"symbols","symbols",1211743),new cljs.core.Keyword(null,"print-meta","print-meta",1034114598),new cljs.core.Keyword(null,"print-length","print-length",1931866356),new cljs.core.Keyword(null,"print-level","print-level",-1825423733)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var self__ = this;
var this$__$1 = this;
var _STAR_print_dup_STAR__orig_val__64113 = cljs.core._STAR_print_dup_STAR_;
var _STAR_print_dup_STAR__temp_val__64114 = false;
(cljs.core._STAR_print_dup_STAR_ = _STAR_print_dup_STAR__temp_val__64114);
...
}finally {(cljs.core._STAR_print_dup_STAR_ = _STAR_print_dup_STAR__orig_val__64113);
}}));
...
var self__ = this;
var this$__$1 = this;
var temp__5751__auto__ = (function (){var G__64115 = cljs.core.first(x);
return (self__.symbols.cljs$core$IFn$_invoke$arity$1 ? self__.symbols.cljs$core$IFn$_invoke$arity$1(G__64115) : self__.symbols.call(null,G__64115));
})();
...
(fipp.edn.EdnPrinter.prototype.fipp$visit$IVisitor$visit_tagged$arity$2 = (function (this$,p__64117){
var self__ = this;
var map__64118 = p__64117;
var map__64118__$1 = cljs.core.__destructure_map(map__64118);
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64118__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64118__$1,new cljs.core.Keyword(null,"form","form",-1624062471));
var this$__$1 = this;
...
var self__ = this;
var this$__$1 = this;
return fipp.edn.pretty_coll(this$__$1,"{",x,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),",",new cljs.core.Keyword(null,"line","line",212345235)], null),"}",(function (printer,p__64119){
var vec__64120 = p__64119;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64120,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64120,(1),null);
...
var self__ = this;
var this$__$1 = this;
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"text","text",-1790561697),(function (){var _STAR_print_readably_STAR__orig_val__64123 = cljs.core._STAR_print_readably_STAR_;
var _STAR_print_readably_STAR__temp_val__64124 = true;
(cljs.core._STAR_print_readably_STAR_ = _STAR_print_readably_STAR__temp_val__64124);

try{return cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([x], 0));
}finally {(cljs.core._STAR_print_readably_STAR_ = _STAR_print_readably_STAR__orig_val__64123);
}})()], null);
}));
...
var self__ = this;
var this$__$1 = this;
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"text","text",-1790561697),(function (){var _STAR_print_readably_STAR__orig_val__64125 = cljs.core._STAR_print_readably_STAR_;
var _STAR_print_readably_STAR__temp_val__64126 = true;
(cljs.core._STAR_print_readably_STAR_ = _STAR_print_readably_STAR__temp_val__64126);

try{return cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([x], 0));
}finally {(cljs.core._STAR_print_readably_STAR_ = _STAR_print_readably_STAR__orig_val__64125);
}})()], null);
}));
...
(fipp.edn.EdnPrinter.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this64094,other64095){
var self__ = this;
var this64094__$1 = this;
return (((!((other64095 == null)))) && ((((this64094__$1.constructor === other64095.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this64094__$1.symbols,other64095.symbols)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this64094__$1.print_meta,other64095.print_meta)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this64094__$1.print_length,other64095.print_length)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this64094__$1.print_level,other64095.print_level)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this64094__$1.__extmap,other64095.__extmap)))))))))))));
}));
...
(fipp.edn.EdnPrinter.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4479__auto__,k64093){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k64093);

}
}));

(fipp.edn.EdnPrinter.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4480__auto__,k__4481__auto__,G__64092){
var self__ = this;
var this__4480__auto____$1 = this;
var pred__64128 = cljs.core.keyword_identical_QMARK_;
var expr__64129 = k__4481__auto__;
if(cljs.core.truth_((pred__64128.cljs$core$IFn$_invoke$arity$2 ? pred__64128.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"symbols","symbols",1211743),expr__64129) : pred__64128.call(null,new cljs.core.Keyword(null,"symbols","symbols",1211743),expr__64129)))){
return (new fipp.edn.EdnPrinter(G__64092,self__.print_meta,self__.print_length,self__.print_level,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__64128.cljs$core$IFn$_invoke$arity$2 ? pred__64128.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"print-meta","print-meta",1034114598),expr__64129) : pred__64128.call(null,new cljs.core.Keyword(null,"print-meta","print-meta",1034114598),expr__64129)))){
return (new fipp.edn.EdnPrinter(self__.symbols,G__64092,self__.print_length,self__.print_level,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__64128.cljs$core$IFn$_invoke$arity$2 ? pred__64128.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"print-length","print-length",1931866356),expr__64129) : pred__64128.call(null,new cljs.core.Keyword(null,"print-length","print-length",1931866356),expr__64129)))){
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,G__64092,self__.print_level,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__64128.cljs$core$IFn$_invoke$arity$2 ? pred__64128.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"print-level","print-level",-1825423733),expr__64129) : pred__64128.call(null,new cljs.core.Keyword(null,"print-level","print-level",-1825423733),expr__64129)))){
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,self__.print_length,G__64092,self__.__meta,self__.__extmap,null));
} else {
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,self__.print_length,self__.print_level,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4481__auto__,G__64092),null));
}
}
}
}
...
(fipp.edn.EdnPrinter.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4471__auto__,G__64092){
var self__ = this;
var this__4471__auto____$1 = this;
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,self__.print_length,self__.print_level,G__64092,self__.__extmap,self__.__hash));
}));
 ...
 */
fipp.edn.map__GT_EdnPrinter = (function fipp$edn$map__GT_EdnPrinter(G__64097){
var extmap__4512__auto__ = (function (){var G__64131 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__64097,new cljs.core.Keyword(null,"symbols","symbols",1211743),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"print-meta","print-meta",1034114598),new cljs.core.Keyword(null,"print-length","print-length",1931866356),new cljs.core.Keyword(null,"print-level","print-level",-1825423733)], 0));
if(cljs.core.record_QMARK_(G__64097)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__64131);
} else {
return G__64131;
}
})();
return (new fipp.edn.EdnPrinter(new cljs.core.Keyword(null,"symbols","symbols",1211743).cljs$core$IFn$_invoke$arity$1(G__64097),new cljs.core.Keyword(null,"print-meta","print-meta",1034114598).cljs$core$IFn$_invoke$arity$1(G__64097),new cljs.core.Keyword(null,"print-length","print-length",1931866356).cljs$core$IFn$_invoke$arity$1(G__64097),new cljs.core.Keyword(null,"print-level","print-level",-1825423733).cljs$core$IFn$_invoke$arity$1(G__64097),null,cljs.core.not_empty(extmap__4512__auto__),null));
});
...
var _STAR_print_meta_STAR__orig_val__64134 = cljs.core._STAR_print_meta_STAR_;
var _STAR_print_meta_STAR__temp_val__64135 = false;
(cljs.core._STAR_print_meta_STAR_ = _STAR_print_meta_STAR__temp_val__64135);

try{return fipp.visit.visit(printer,x);
}finally {(cljs.core._STAR_print_meta_STAR_ = _STAR_print_meta_STAR__orig_val__64134);
}}));
