...
var G__71709 = o;
goog.object.set(G__71709,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__71727__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__71727 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__71728__i = 0, G__71728__a = new Array(arguments.length -  0);
while (G__71728__i < G__71728__a.length) {G__71728__a[G__71728__i] = arguments[G__71728__i + 0]; ++G__71728__i;}
  args = new cljs.core.IndexedSeq(G__71728__a,0,null);
} 
return G__71727__delegate.call(this,args);};
G__71727.cljs$lang$maxFixedArity = 0;
G__71727.cljs$lang$applyTo = (function (arglist__71729){
var args = cljs.core.seq(arglist__71729);
return G__71727__delegate(args);
});
G__71727.cljs$core$IFn$_invoke$arity$variadic = G__71727__delegate;
return G__71727;
})()
;
} else {
...
var G__71710 = o;
goog.object.set(G__71710,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__71730__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__71730 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__71731__i = 0, G__71731__a = new Array(arguments.length -  0);
while (G__71731__i < G__71731__a.length) {G__71731__a[G__71731__i] = arguments[G__71731__i + 0]; ++G__71731__i;}
  args = new cljs.core.IndexedSeq(G__71731__a,0,null);
} 
return G__71730__delegate.call(this,args);};
G__71730.cljs$lang$maxFixedArity = 0;
G__71730.cljs$lang$applyTo = (function (arglist__71732){
var args = cljs.core.seq(arglist__71732);
return G__71730__delegate(args);
});
G__71730.cljs$core$IFn$_invoke$arity$variadic = G__71730__delegate;
return G__71730;
})()
;
} else {
...
var G__71711 = props;
var G__71711__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__71711,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__71711);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__71711__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4223__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__71712 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__71712,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__71712;
}
})(),id_class);
...
var G__71713 = (cljs.core.count(argv) - first_child);
switch (G__71713) {
case (0):
...
var vec__71714 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71714,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71714,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71714,(2),null);
...
var temp__5757__auto___71738 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___71738 == null)){
} else {
var key_71739 = temp__5757__auto___71738;
(jsprops.key = key_71739);
}
...
var temp__5757__auto___71740 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___71740 == null)){
} else {
var key_71741 = temp__5757__auto___71740;
(jsprops.key = key_71741);
}
...
var temp__5757__auto___71744 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___71744 == null)){
} else {
var key_71745 = temp__5757__auto___71744;
(jsprops.key = key_71745);
}
...
var temp__5757__auto___71749 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___71749 == null)){
} else {
var key_71750 = temp__5757__auto___71749;
(jsprops.key = key_71750);
}
...
var temp__5757__auto___71751 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___71751 == null)){
} else {
var key_71752 = temp__5757__auto___71751;
(jsprops.key = key_71752);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__71717_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__71717_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__71718 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71718,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71718,(1),null);
...
break;
default:
var G__71767 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__71768 = compiler;
v = G__71767;
compiler = G__71768;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template71724 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template71724 = (function (opts,id,fn_to_element,parse_fn,meta71725){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta71725 = meta71725;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template71724.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_71726,meta71725__$1){
var self__ = this;
var _71726__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template71724(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta71725__$1));
}));

(reagent.impl.template.t_reagent$impl$template71724.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_71726){
var self__ = this;
var _71726__$1 = this;
return self__.meta71725;
}));

(reagent.impl.template.t_reagent$impl$template71724.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template71724.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template71724.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template71724.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template71724.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template71724.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta71725","meta71725",1771708466,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template71724.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template71724.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template71724");

(reagent.impl.template.t_reagent$impl$template71724.cljs$lang$ctorPrWriter = (function (this__4461__auto__,writer__4462__auto__,opt__4463__auto__){
return cljs.core._write(writer__4462__auto__,"reagent.impl.template/t_reagent$impl$template71724");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template71724.
 */
reagent.impl.template.__GT_t_reagent$impl$template71724 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template71724(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta71725){
return (new reagent.impl.template.t_reagent$impl$template71724(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta71725));
});

}

return (new reagent.impl.template.t_reagent$impl$template71724(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
