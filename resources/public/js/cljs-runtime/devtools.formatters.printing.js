...
var len__4829__auto___62395 = arguments.length;
var i__4830__auto___62396 = (0);
while(true){
if((i__4830__auto___62396 < len__4829__auto___62395)){
args__4835__auto__.push((arguments[i__4830__auto___62396]));

var G__62397 = (i__4830__auto___62396 + (1));
i__4830__auto___62396 = G__62397;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq62327){
...
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__62328,G__62329,seq62327__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__62364_SHARP_){
return (!((cljs.core.meta(p1__62364_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62373__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e62374){var _e__61146__auto__ = e62374;
return false;
}})();
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
...
}catch (e62376){var _e__61146__auto__ = e62376;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__62383 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__62384 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__62384);

try{var map__62389 = opts;
var map__62389__$1 = cljs.core.__destructure_map(map__62389);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62389__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__62383);
}});
...
var temp__5751__auto___62406 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___62406)){
var managed_print_level_62407 = temp__5751__auto___62406;
var _STAR_print_level_STAR__orig_val__62392_62408 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__62393_62409 = managed_print_level_62407;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__62393_62409);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__62391_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__62391_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__62392_62408);
}} else {
job_fn();
}
