...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__62091){
var map__62092 = p__62091;
var map__62092__$1 = cljs.core.__destructure_map(map__62092);
var request = map__62092__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62092__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__62095 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__62095.cljs$core$IFn$_invoke$arity$1 ? fexpr__62095.cljs$core$IFn$_invoke$arity$1(response) : fexpr__62095.call(null,response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__62096 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__62096.cljs$core$IFn$_invoke$arity$1 ? fexpr__62096.cljs$core$IFn$_invoke$arity$1(response) : fexpr__62096.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__62099){
var map__62100 = p__62099;
var map__62100__$1 = cljs.core.__destructure_map(map__62100);
var request = map__62100__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62100__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
