...
var fipp$ednize$IEdn$_edn$dyn_63133 = (function (x){
...
return fipp$ednize$IEdn$_edn$dyn_63133(x);
}
});
...
return cljs.core.tagged_literal(new cljs.core.Symbol(null,"js","js",-886355190,null),cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4622__auto__ = (function fipp$ednize$edn_$_iter__63103(s__63104){
return (new cljs.core.LazySeq(null,(function (){
var s__63104__$1 = s__63104;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__63104__$1);
if(temp__5753__auto__){
var s__63104__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__63104__$2)){
var c__4620__auto__ = cljs.core.chunk_first(s__63104__$2);
var size__4621__auto__ = cljs.core.count(c__4620__auto__);
var b__63108 = cljs.core.chunk_buffer(size__4621__auto__);
if((function (){var i__63107 = (0);
while(true){
if((i__63107 < size__4621__auto__)){
var k = cljs.core._nth(c__4620__auto__,i__63107);
cljs.core.chunk_append(b__63108,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(x[k])], null));

var G__63135 = (i__63107 + (1));
i__63107 = G__63135;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__63108),fipp$ednize$edn_$_iter__63103(cljs.core.chunk_rest(s__63104__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__63108),null);
}
} else {
var k = cljs.core.first(s__63104__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(x[k])], null),fipp$ednize$edn_$_iter__63103(cljs.core.rest(s__63104__$2)));
}
} else {
return null;
}
