...
var vec__61976 = cljs.core.rest(expr);
...
var vec__61979 = first__61978;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61979,(0),null);
var form = seq__61977__$1;
...
var G__61982 = x;
var G__61982__$1 = (((G__61982 == null))?null:spec_tools.impl.polish(G__61982));
var G__61982__$2 = (((G__61982__$1 == null))?null:cljs.core.name(G__61982__$1));
if((G__61982__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__61982__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__61983 = x;
var G__61983__$1 = (((G__61983 == null))?null:cljs.core.name(G__61983));
if((G__61983__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__61983__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__61984){
var map__61985 = p__61984;
var map__61985__$1 = cljs.core.__destructure_map(map__61985);
var data = map__61985__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61985__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61985__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61985__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61985__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__61986){
var map__61987 = p__61986;
var map__61987__$1 = cljs.core.__destructure_map(map__61987);
var data = map__61987__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61987__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61987__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__61988 = data;
var G__61988__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__61988,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__61988);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__61988__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__61988__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__61992 = form;
var G__61992__$1 = (((G__61992 == null))?null:cljs.core.rest(G__61992));
if((G__61992__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__61992__$1);
}
})();
var G__61993 = m;
var G__61993__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__61993,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__61989_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__61989_SHARP_)));
})):G__61993);
var G__61993__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__61993__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__61990_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__61990_SHARP_)));
})):G__61993__$1);
var G__61993__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__61993__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__61991_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__61991_SHARP_));
})):G__61993__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__61993__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__61994 = (function (){var G__61995 = form;
var G__61995__$1 = (((G__61995 == null))?null:cljs.core.rest(G__61995));
if((G__61995__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__61995__$1);
}
})();
var map__61994__$1 = cljs.core.__destructure_map(map__61994);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61994__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61994__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61994__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61994__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__61996 = (function (){var and__4221__auto__ = (kw instanceof cljs.core.Symbol);
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__61997 = form;
var G__61997__$1 = (((G__61997 == null))?null:cljs.core.seq(G__61997));
var G__61997__$2 = (((G__61997__$1 == null))?null:cljs.core.first(G__61997__$1));
if((G__61997__$2 == null)){
return null;
} else {
var fexpr__61998 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__61998.cljs$core$IFn$_invoke$arity$1 ? fexpr__61998.cljs$core$IFn$_invoke$arity$1(G__61997__$2) : fexpr__61998.call(null,G__61997__$2));
}
})():null));
});
/**
...
var len__4829__auto___62021 = arguments.length;
var i__4830__auto___62022 = (0);
while(true){
if((i__4830__auto___62022 < len__4829__auto___62021)){
args__4835__auto__.push((arguments[i__4830__auto___62022]));

var G__62024 = (i__4830__auto___62022 + (1));
i__4830__auto___62022 = G__62024;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq62002){
var self__4817__auto__ = this;
return self__4817__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq62002));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__62003){
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__62009){
var map__62010 = p__62009;
var map__62010__$1 = cljs.core.__destructure_map(map__62010);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62010__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62010__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62010__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62010__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__62007_SHARP_){
return cljs.core.map_QMARK_(p1__62007_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__62008_SHARP_){
return cljs.core.contains_QMARK_(p1__62008_SHARP_,x);
});
}),req_keys));
