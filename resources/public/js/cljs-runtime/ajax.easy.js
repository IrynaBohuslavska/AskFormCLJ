...
var G__62135 = format;
var G__62135__$1 = (((G__62135 instanceof cljs.core.Keyword))?G__62135.fqn:null);
switch (G__62135__$1) {
case "transit":
return ajax.transit.transit_request_format.cljs$core$IFn$_invoke$arity$1(format_params);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__62136 = cljs.core.second(format);
var G__62137 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__62136,G__62137) : ajax.easy.keyword_response_format_element.call(null,G__62136,G__62137));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__62139_SHARP_){
return ajax.easy.keyword_response_format_element(p1__62139_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__62140){
var map__62141 = p__62140;
var map__62141__$1 = cljs.core.__destructure_map(map__62141);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62141__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62141__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62141__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return (function ajax$easy$transform_handler_$_easy_handler(p__62142){
var vec__62143 = p__62142;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62143,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62143,(1),null);
var fexpr__62146_62152 = (cljs.core.truth_(ok)?h:e);
(fexpr__62146_62152.cljs$core$IFn$_invoke$arity$1 ? fexpr__62146_62152.cljs$core$IFn$_invoke$arity$1(result) : fexpr__62146_62152.call(null,result));
...
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__62147){
var map__62148 = p__62147;
var map__62148__$1 = cljs.core.__destructure_map(map__62148);
var opts = map__62148__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62148__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62148__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62148__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62148__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62148__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
