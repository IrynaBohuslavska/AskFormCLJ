...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_64389 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_64389(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_64390 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_64390(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_64391 = (function (reader,ch){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_64391(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_64392 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_64392(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_64393 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_64393(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_64394 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_64394(reader);
}
});
...
var G__64398 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__64399 = s.append(c);
c = G__64398;
s = G__64399;
continue;
}
