...
var hierarchy__4716__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.swagger.core","default","spec-tools.swagger.core/default",1361779456)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__63497 = cljs.core.get_global_hierarchy;
return (fexpr__63497.cljs$core$IFn$_invoke$arity$0 ? fexpr__63497.cljs$core$IFn$_invoke$arity$0() : fexpr__63497.call(null));
})());
...
spec_tools.swagger.core.accept_spec.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),(function (_,___$1,children,p__63507){
var map__63508 = p__63507;
var map__63508__$1 = cljs.core.__destructure_map(map__63508);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63508__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63508__$1,new cljs.core.Keyword(null,"in","in",-1531184865));
...
var vec__63510 = spec_tools.impl.extract_form(spec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63510,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63510,(1),null);
...
var method_cache__4714__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4715__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4716__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__63516 = cljs.core.get_global_hierarchy;
return (fexpr__63516.cljs$core$IFn$_invoke$arity$0 ? fexpr__63516.cljs$core$IFn$_invoke$arity$0() : fexpr__63516.call(null));
})());
...
var map__63519 = spec_tools.swagger.core.transform.cljs$core$IFn$_invoke$arity$2(spec,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),in$,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"parameter","parameter",1978789597)], null));
var map__63519__$1 = cljs.core.__destructure_map(map__63519);
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63519__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63519__$1,new cljs.core.Keyword(null,"required","required",1807647006));
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__63520){
var vec__63521 = p__63520;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63521,(0),null);
var map__63524 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63521,(1),null);
var map__63524__$1 = cljs.core.__destructure_map(map__63524);
var schema = map__63524__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63524__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
var method_cache__4714__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4715__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4716__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__63525 = cljs.core.get_global_hierarchy;
return (fexpr__63525.cljs$core$IFn$_invoke$arity$0 ? fexpr__63525.cljs$core$IFn$_invoke$arity$0() : fexpr__63525.call(null));
})());
...
})(),(function (){var iter__4622__auto__ = (function spec_tools$swagger$core$iter__63527(s__63528){
return (new cljs.core.LazySeq(null,(function (){
var s__63528__$1 = s__63528;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__63528__$1);
if(temp__5753__auto__){
var s__63528__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__63528__$2)){
var c__4620__auto__ = cljs.core.chunk_first(s__63528__$2);
var size__4621__auto__ = cljs.core.count(c__4620__auto__);
var b__63530 = cljs.core.chunk_buffer(size__4621__auto__);
if((function (){var i__63529 = (0);
while(true){
if((i__63529 < size__4621__auto__)){
var vec__63531 = cljs.core._nth(c__4620__auto__,i__63529);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63531,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63531,(1),null);
cljs.core.chunk_append(b__63530,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [status,(function (){var $ = response;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__63530),spec_tools$swagger$core$iter__63527(cljs.core.chunk_rest(s__63528__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__63530),null);
}
} else {
var vec__63534 = cljs.core.first(s__63528__$2);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63534,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63534,(1),null);
...
var $__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"schema","schema",-1582001791).cljs$core$IFn$_invoke$arity$1($))?cljs.core.update.cljs$core$IFn$_invoke$arity$4($,new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.swagger.core.transform,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"schema","schema",-1582001791)], null)):$);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3($__$1,new cljs.core.Keyword(null,"description","description",-1428560544),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,""));
})()], null),spec_tools$swagger$core$iter__63527(cljs.core.rest(s__63528__$2)));
}
} else {
return null;
}
...
var new$ = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__63537){
var vec__63538 = p__63537;
var in$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63538,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63538,(1),null);
return spec_tools.swagger.core.extract_parameter.cljs$core$IFn$_invoke$arity$2(in$,spec);
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([v], 0));
var merged = cljs.core.vec(cljs.core.reverse(cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__63541,p){
var vec__63542 = p__63541;
var ps = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63542,(0),null);
var cache = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63542,(1),null);
var acc__$1 = vec__63542;
