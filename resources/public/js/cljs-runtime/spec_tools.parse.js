...
var fexpr__62018 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__62018.cljs$core$IFn$_invoke$arity$1 ? fexpr__62018.cljs$core$IFn$_invoke$arity$1(type) : fexpr__62018.call(null,type));
});
...
var G__62026 = spec_tools.impl.normalize_symbol(x);
var G__62027 = null;
var G__62028 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__62026,G__62027,G__62028) : spec_tools.parse.parse_form.call(null,G__62026,G__62027,G__62028));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__62029 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__62030 = x;
var G__62031 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__62029,G__62030,G__62031) : spec_tools.parse.parse_form.call(null,G__62029,G__62030,G__62031));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__62185 = cljs.spec.alpha.form(x);
var G__62186 = options;
x = G__62185;
options = G__62186;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__62032 = spec_tools.impl.normalize_symbol(spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x));
var G__62033 = null;
var G__62034 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__62032,G__62033,G__62034) : spec_tools.parse.parse_form.call(null,G__62032,G__62033,G__62034));
} else {
...
var G__62039 = parse_data;
var G__62039__$1 = (((G__62039 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__62039));
var G__62039__$2 = (((G__62039__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__62039__$1));
var G__62039__$3 = (((G__62039__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__62039__$2));
var G__62039__$4 = (((G__62039__$3 == null))?null:cljs.core.seq(G__62039__$3));
if((G__62039__$4 == null)){
return null;
} else {
return cljs.core.set(G__62039__$4);
}
}
});
...
var hierarchy__4716__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.parse","default","spec-tools.parse/default",-1184283850)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__62040 = cljs.core.get_global_hierarchy;
return (fexpr__62040.cljs$core$IFn$_invoke$arity$0 ? fexpr__62040.cljs$core$IFn$_invoke$arity$0() : fexpr__62040.call(null));
})());
...
var map__62101 = spec_tools.impl.parse_keys(form);
var map__62101__$1 = cljs.core.__destructure_map(map__62101);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62101__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62101__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62101__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62101__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62101__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__62108 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__62108__$1 = (cljs.core.truth_((function (){var or__4223__auto__ = req;
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__62108,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__62108);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__62108__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__62108__$1;
}
}));
...
var vec__62112 = multi_spec_form;
var seq__62113 = cljs.core.seq(vec__62112);
var first__62114 = cljs.core.first(seq__62113);
var seq__62113__$1 = cljs.core.next(seq__62113);
var _ = first__62114;
var first__62114__$1 = cljs.core.first(seq__62113__$1);
var seq__62113__$2 = cljs.core.next(seq__62113__$1);
var multi_method_symbol = first__62114__$1;
var ___$1 = seq__62113__$2;
var form = vec__62112;
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__62121){
var vec__62125 = p__62121;
var spec_k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62125,(0),null);
var method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62125,(1),null);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__62136_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__62136_SHARP_,options);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__62137_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__62137_SHARP_,options);
}),cljs.core.rest(form));
...
var type_priority = (function (p1__62140_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__62140_SHARP_),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724))){
return (1);
} else {
return (0);
}
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__62141_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__62141_SHARP_,options);
}),cljs.core.rest(form))));
}));
...
var map__62142 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__62142__$1 = cljs.core.__destructure_map(map__62142);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62142__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__62143 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__62143__$1 = cljs.core.__destructure_map(map__62143);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62143__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__62157,options){
var vec__62163 = p__62157;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62163,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62163,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62163,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__62174,options){
var vec__62175 = p__62174;
var seq__62176 = cljs.core.seq(vec__62175);
var first__62177 = cljs.core.first(seq__62176);
var seq__62176__$1 = cljs.core.next(seq__62176);
var ___$1 = first__62177;
var values = seq__62176__$1;
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__62173_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__62173_SHARP_,options);
}),values);
...
var type_priority = (function (p1__62178_SHARP_){
var G__62181 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),(1),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724),(0)], null);
var fexpr__62180 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__62178_SHARP_);
return (fexpr__62180.cljs$core$IFn$_invoke$arity$1 ? fexpr__62180.cljs$core$IFn$_invoke$arity$1(G__62181) : fexpr__62180.call(null,G__62181));
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__62179_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__62179_SHARP_,options);
}),cljs.core.rest(form))));
}));
